...
function show_password() {
	$('#showpassword-trigger').click( function () {
	var pswd = $(this).next('input').val(),
	type = $(this).next('input').is("input[type='text']") ? 'password' : 'text',
	html = '<input id="user_password" type="'+type+'" name="user[password]" />';
